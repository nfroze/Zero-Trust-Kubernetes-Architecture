...
# Managed Node Group
#
# Nodes are placed in private subnets only — no direct internet exposure.
# Cilium requires nodes to be running before it can be installed, so the
# node group has no dependency on the Cilium module.
###############################################################################
